...
// //   it('should be true when breakpoint < lg (1367)', () => {
// //     const {
// //       result: { current: isBreakPointBelowLG },
// //     } = renderHook(() => useMediaQuery(mediaQueryBreakpoints.down('md3')))
// //
// //     act(() => {
// //       window.resizeTo(1300, 500)
// //     })
// //     expect(isBreakPointBelowLG).toBe(true)
// //   })
// //
// //   it('should be false when breakpoint > lg (1367)', () => {
// //     const {
// //       result: { current: isBreakPointBelowLG },
// //     } = renderHook(() => useMediaQuery(mediaQueryBreakpoints.up('md3')))
// //
// //     act(() => {
// //       window.resizeTo(1300, 500)
// //     })
// //     expect(isBreakPointBelowLG).toBe(false)
// //   })
// //
// //   it('should be true when screen 1500 then false when screen 1300', () => {
// //     const {
// //       result: { current: isBreakPointBelowLG },
// //     } = renderHook(() => useMediaQuery(mediaQueryBreakpoints.down('md3')))
// //
...
// //     waitFor(() => {
// //       console.log(isBreakPointBelowLG)
// //       expect(isBreakPointBelowLG).toBe(true)
// //     })
// //   })
// // })
